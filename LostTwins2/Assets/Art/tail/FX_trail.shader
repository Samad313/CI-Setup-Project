...
Shader "mkULTRA/FX_Tail"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode1 = tex2D( _main, panner6 );
			float4 lerpResult29 = lerp( _Color_B , _color_A , tex2DNode1);
			...
			float temp_output_12_0 = (( _D * -1.0 ) + (i.uv_texcoord.x - 0.0) * (1.0 - ( _D * -1.0 )) / (1.0 - 0.0));
			float clampResult55 = clamp( ( tex2DNode1.r * saturate( ( ( tex2D( _eros, panner54 ).a - temp_output_12_0 ) / ( ( temp_output_12_0 + _D ) - temp_output_12_0 ) ) ) ) , 0.0 , 1.0 );
			clip( clampResult55 - _Cutoff );
		}
...
/*ASEBEGIN
Version=17700
-58;489;1534;660;829.4583;354.5035;2.041392;True;True
...
ASEEND*/
//CHKSM=8954AE0BB3334CF7499CB00C7056C9BFF44AABE7