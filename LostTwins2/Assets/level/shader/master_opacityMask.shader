// Upgrade NOTE: upgraded instancing buffer 'mkULTRAmaster_opacitymask_OLD' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "mkULTRA/master_opacitymask_OLD"
{
	Properties
	{
		_ALB("ALB", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform half4 _ALB_Tint;
		uniform sampler2D _ALB;
		uniform half _emissiveBoost;
		uniform sampler2D _matcap_ALPHA;
		uniform sampler2D _Matcap;
		uniform half _matcapintensity;
		uniform sampler2D _transparent;
		uniform half _opacity_scroll_speed;

		UNITY_INSTANCING_BUFFER_START(mkULTRAmaster_opacitymask_OLD)
			UNITY_DEFINE_INSTANCED_PROP(half4, _ALB_ST)
#define _ALB_ST_arr mkULTRAmaster_opacitymask_OLD
			UNITY_DEFINE_INSTANCED_PROP(half4, _matcap_ALPHA_ST)
#define _matcap_ALPHA_ST_arr mkULTRAmaster_opacitymask_OLD
			UNITY_DEFINE_INSTANCED_PROP(half, _Opacity)
#define _Opacity_arr mkULTRAmaster_opacitymask_OLD
		UNITY_INSTANCING_BUFFER_END(mkULTRAmaster_opacitymask_OLD)

		void surf( Input i , inout SurfaceOutput o )
		{
			half4 _ALB_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(_ALB_ST_arr, _ALB_ST);
			float2 uv_ALB = i.uv_texcoord * _ALB_ST_Instance.xy + _ALB_ST_Instance.zw;
			half4 tex2DNode1 = tex2D( _ALB, uv_ALB );
			o.Albedo = ( _ALB_Tint * tex2DNode1 ).rgb;
			half4 _matcap_ALPHA_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(_matcap_ALPHA_ST_arr, _matcap_ALPHA_ST);
			float2 uv_matcap_ALPHA = i.uv_texcoord * _matcap_ALPHA_ST_Instance.xy + _matcap_ALPHA_ST_Instance.zw;
			half3 ase_worldNormal = i.worldNormal;
			o.Emission = ( ( tex2DNode1 * _emissiveBoost ) + ( ( tex2D( _matcap_ALPHA, uv_matcap_ALPHA ) * tex2D( _Matcap, ( ( mul( UNITY_MATRIX_V, half4( ase_worldNormal , 0.0 ) ).xyz * 0.5 ) + 0.5 ).xy ) * tex2DNode1 ) * _matcapintensity ) ).rgb;
			half mulTime37 = _Time.y * _opacity_scroll_speed;
			half2 appendResult39 = (half2(mulTime37 , 0.0));
			...
			half4 clampResult33 = clamp( ( tex2D( _transparent, uv4_TexCoord29 ) + _Opacity_Instance ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
...
/*ASEBEGIN
Version=17700
-186;-1029;1855;1023;-94.98635;657.453;1.299298;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;40;397.2997,-58.56808;Inherit;False;Property;_opacity_scroll_speed;opacity_scroll_speed;9;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;31;1208.004,224.8316;Inherit;False;InstancedProperty;_Opacity;Opacity;8;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;310.6967,-286.1362;Inherit;False;Property;_emissiveBoost;emissive Boost;5;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;19;1371.739,-145.1376;Inherit;True;Property;_transparent;transparent;7;0;Create;True;0;0;False;0;-1;None;c14585e9c88cfc346aca540b7135f2fc;True;2;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;17;-559.2619,-608.5116;Inherit;False;Property;_ALB_Tint;ALB_Tint;6;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;2354.778,-436.0095;Half;False;True;-1;2;ASEMaterialInspector;0;0;Lambert;mkULTRA/master_opacitymask_OLD;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Transparent;;AlphaTest;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;0;False;-1;0;False;-1;0;False;0.02;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;4;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=CDB6A1580615435F54815C1ECF6DE578329F62C3